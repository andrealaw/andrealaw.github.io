...
Some thinking
-   use Firebase Admin SDK instead of Firebase SDK to similar the server environment
-   avoid nest data structure
-   use test cases and Postman for testing
-   ".indexOn" is used at the database rule settings to improve the performance of some queries
...
// e.g. "./todo-listfirebase-adminsdk.json"
var serviceAccount = require("./example.json");
