...
Requirement: Update a JSON object of a musical album collection.
...
If prop is "tracks" and value isn't empty (""), push the valueonto the end of the album's existing tracks array.
